(function() {
    ...
    as.config(function($routeProvider, $httpProvider) {
        $routeProvider
                ...
                .when('/usuarios', {templateUrl: 'partials/user/list.html', controller: 'ListUsuarioCtrl'})
                .when('/usuarios/new', {templateUrl: 'partials/user/new.html', controller: 'NewUsuarioCtrl'})
                .when('/usuarios/edit/:id', {templateUrl: 'partials/user/edit.html', controller: 'EditUsuarioCtrl'})
                ...
                function($q) {
                    ...
                    var setMessage = function(response) {
                        ...
                        if (response.data.message) {
                            showMessage(response.data.message.text, response.data.message.type)
                        }
                        if (response.data.error) {
                            showMessage(response.data.message.text, 'error')
                        }
                    };
                            ...
                            $http.post(apiUrl + '/j_spring_security_check', 'j_username='+username+'&j_password='+password, {headers: {'Content-Type': 'application/x-www-form-urlencoded'}})
                                .success(function(data){
                                    ...
                                    if(data.success) {
                                        ...
                                        $http.get(apiUrl + "/user/get?username=${data.username}")
                                            .success(function(data){
