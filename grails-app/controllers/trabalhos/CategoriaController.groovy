...
class CategoriaController extends RestfulController {
    ...
    def save(Categoria categoriaInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'categoriaInstance.label', default: 'Categoria'), categoriaInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'categoriaInstance.label', default: 'Categoria'), params.id])
                redirect action: "index", method: "GET"
            }
