<div ng-controller="EditTrabalhoCtrl">
	<form class="form-horizontal">
		<h1 class="page-header"><g:message code="myapp.EditWork"/></h1>
		<fieldset>
			...
			<div class="control-group">
				...
				<!-- ng-options="o.id as o.nome for o in orientadores" -->
					...
					<a title="Adicionar orientador" ng-click="adicionarOrientador()" class="btn"><i class="icon-plus"></i> <g:message code="myapp.AddLeader"/></a>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label" for="resumo"><g:message code="myapp.Authors"/></label>
				<div class="controls">
					...
					<a title="Adicionar autor" ng-click="adicionarAutor()" class="btn"><i class="icon-plus"></i><g:message code="myapp.AddAuthor"/></a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="palavrasChave"><g:message code="myapp.Keywords"/></label>
				<div class="controls">
		...
		<div class="form-actions">
			<button ng-click="updateTrabalho()" class="btn btn-primary"><g:message code="myapp.Save"/></button>
		</div>
	</form>
</div>